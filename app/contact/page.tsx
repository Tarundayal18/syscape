    ...
    <main className="bg-black min-h-screen overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-16 sm:pt-20 overflow-x-hidden bg-gradient-to-b from-[#6ea7ee] via-[#495f8f]/50 to-black">
        ...
        <div className="relative z-10 max-w-5xl mx-auto w-full">
          ...
          {/* Contact Cards */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 mt-12 sm:mt-16 md:mt-20 w-full">
            {/* Email Card */}
            <div
              className="bg-[#1a1a2e]/80 border border-gray-700 rounded-xl sm:rounded-2xl p-6 sm:p-8 backdrop-blur-sm hover:border-[#495f8f]/50 transition-all duration-300 w-full"
              style={{
                transform: isMobile ? `translateY(0)` : `translateY(${Math.min(scrollY * 0.2, 50)}px)`,
                opacity: 1 - Math.max(0, (scrollY - 300) / 500),
              }}
            >
              <div className="flex items-center gap-3 sm:gap-4 mb-4 flex-wrap">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-white break-words">support@datacore.com</h3>
              </div>
              <p className="text-gray-400 text-xs sm:text-sm leading-relaxed">
                Reach out for product help, billing questions, or account support. We typically respond within 1
                business day.
      ...
      <section className="relative py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8 bg-[#212121] overflow-x-hidden">
        <div className="max-w-6xl mx-auto w-full">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center w-full">
            ...
            {/* Right Column - Form */}
            <div
              className="bg-[#1a1a2e] border border-gray-800 rounded-xl sm:rounded-2xl p-6 sm:p-8 mt-8 md:mt-0 w-full min-w-0"
              style={{
                opacity: Math.max(0, Math.min(1, (scrollY - 200) / 300)),
                transform: isMobile ? `translateX(0)` : `translateX(${Math.min(50, 50 - (scrollY - 200) / 12)}px)`,
              }}
