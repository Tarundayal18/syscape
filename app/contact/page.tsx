...
//       <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-20 overflow-hidden bg-gradient-to-b from-purple-900 via-purple-900/50 to-black">
//         {/* Animated background orbs */}
//         <div className="absolute inset-0 overflow-hidden">
//           <div className="absolute top-32 left-1/4 w-96 h-96 bg-purple-500/20 rounded-full blur-3xl animate-pulse"></div>
//           <div className="absolute bottom-32 right-1/4 w-96 h-96 bg-purple-600/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
//         </div>
...
//             {/* Email Card */}
//             <div
//               className="bg-[#1a1a2e]/80 border border-gray-700 rounded-2xl p-8 backdrop-blur-sm hover:border-purple-500/50 transition-all duration-300"
//               style={{
...
//               className="space-y-8"
//               style={{
//                 opacity: Math.max(0, Math.min(1, (scrollY - 600) / 300)),
//                 transform: `translateX(${Math.max(-50, -50 + (scrollY - 600) / 12)}px)`,
//               }}
//             >
//               <div>
...
//               style={{
//                 opacity: Math.max(0, Math.min(1, (scrollY - 600) / 300)),
//                 transform: `translateX(${Math.min(50, 50 - (scrollY - 600) / 12)}px)`,
//               }}
//             >
...
//                     rows={4}
//                     className="w-full bg-black border border-gray-700 rounded-lg px-4 py-3 text-white placeholder-gray-600 focus:outline-none focus:border-purple-500 transition-colors resize-none"
//                   ></textarea>
//                 </div>

//                 {/* Checkbox */}
//                 <div className="flex items-start gap-2">
//                   <input type="checkbox" id="privacy" className="mt-1 w-5 h-5 accent-purple-500 cursor-pointer" />
...
//                 <button
//                   type="submit"
//                   className="w-full py-3 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white font-semibold rounded-lg transition-all transform hover:scale-105"
//                 >
//                   Create Free Account
//                 </button>
//               </form>
