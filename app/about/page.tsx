...
//               We're committed to transforming how businesses manage their sales pipelines with innovative technology and
//               exceptional support.
//             </p>
//           </div>
...
//             style={{
//               opacity: Math.max(0, Math.min(1, (scrollY - 500) / 300)),
//               transform: `translateY(${Math.max(-50, -50 + (scrollY - 500) / 12)}px)`,
//             }}
//           >
//             <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">Our Mission</h2>
//             <p className="text-lg text-gray-400 leading-relaxed">
//               At our core, we believe every sales team deserves tools that work as hard as they do. Our mission is to
//               empower businesses of all sizes with powerful, intuitive software that streamlines their sales process and
//               drives sustainable growth. We're not just building software—we're building relationships.
//             </p>
//           </div>
...
//               { title: "Impact", desc: "We measure success by the value we create for our customers" },
//             ].map((value, idx) => (
//               <div
//                 key={idx}
//                 className="bg-[#1a1f2e] border border-gray-800 rounded-xl p-8 hover:border-[#495f8f]/50 transition-all"
//                 style={{
//                   opacity: Math.max(0, Math.min(1, (scrollY - 800 - idx * 100) / 300)),
//                   transform: `translateY(${Math.max(-50, -50 + (scrollY - 800 - idx * 100) / 12)}px)`,
//                 }}
//               >
...
//             className="text-center mb-16"
//             style={{
//               opacity: Math.max(0, Math.min(1, (scrollY - 1200) / 300)),
//               transform: `translateY(${Math.max(-50, -50 + (scrollY - 1200) / 20)}px)`,
//             }}
//           >
...
//                 style={{
//                   opacity: Math.max(0, Math.min(1, (scrollY - 1400 - member * 100) / 300)),
//                   transform: `translateY(${Math.max(-40, -40 + (scrollY - 1400 - member * 100) / 15)}px)`,
//                 }}
//               >
...
//             className="text-center mb-16"
//             style={{
//               opacity: Math.max(0, Math.min(1, (scrollY - 1800) / 300)),
//               transform: `translateY(${Math.max(-50, -50 + (scrollY - 1800) / 20)}px)`,
//             }}
//           >
...
//                 style={{
//                   opacity: Math.max(0, Math.min(1, (scrollY - 2000 - idx * 80) / 300)),
//                   transform: `scale(${Math.max(0.9, Math.min(1, 0.9 + (scrollY - 2000 - idx * 80) / 3000))})`,
//                 }}
//               >
