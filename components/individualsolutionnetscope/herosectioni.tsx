...
export default function Herosectioni() {
 ...
 NetScope Vision          </h1>
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-1xl mx-auto leading-relaxed px-4">
The enterprise-grade monitoring and observability platform engineered for the modern hybrid world. It
                delivers unified visibility across IT, cloud, and OT, while integrating advanced AI/ML capabilities to
                reduce noise, accelerate incident diagnosis, and automate remediation.          </p>
                <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-1xl mx-auto leading-relaxed px-4 translate-y-10">                Achieve higher reliability and operational excellence.
</p>
        </div>
      </div>
    </section>
