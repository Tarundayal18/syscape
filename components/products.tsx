...
//                 <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-blue-500 to-gray-700 rounded-lg flex items-center justify-center text-white text-2xl sm:text-3xl font-bold">
//                   S
//                 </div>
//               </div>
//             </div>
...
//               <div className="w-12 h-12 sm:w-16 sm:h-16 border-2 border-gray-600 rounded-lg flex items-center justify-center text-white text-xl sm:text-2xl font-bold mb-4">
//                 S
//               </div>
